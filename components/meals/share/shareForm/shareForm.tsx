...
export default function ShareForm({label, name}:PickerProps) {
  return (
    <>
      <form className="flex flex-col p-[40px] w-[800px] border-4 border-papaya-whip border-dashed rounded-[50px] mt-[100px]">
        <div className="">
        ...
        <p className="flex justify-center items-center gap-1 mt-[10px] ">
          <button className="bg-papaya-whip w-[200px] p-[10px] text-[20px] text-barn-red rounded-xl hover:bg-barn-red hover:text-papaya-whip cursor-pointer transition hover:scale-105 active:scale-95" type="submit">Share Meal</button>
        </p>
      </form>
    </>
  );
